...
public class CustomerValidation {
	...
	public static Customer validateCustomer(String firstName,String lastName,String emailId,String password,
			double registrationAmount,String dob,String plan,Map<String,Customer> customerList) throws CustomerException
	{
...
//		String email=validateEmail(emailId);
  ...
  public static void duplicateEmail(String emailId, Map<String,Customer> customerList) throws CustomerException
  {
	  validateEmail(emailId);
	  Customer newCust=new Customer(emailId);
	  if(customerList.containsKey(emailId))
